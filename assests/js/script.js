...
// <!-- typed js effect starts -->
    var typed = new Typed(".typing-text", {
        strings: ["front end development", "Backend Development", "Open Source", "Data Science", "Machine Learning"],
        loop: true,
        typeSpeed: 50,
		backSpeed: 25,
		backDelay: 500,
...
var Tawk_API=Tawk_API||{}, Tawk_LoadStart=new Date();
  ...
  s1.async=true;
  s1.src='https://embed.tawk.to/6143872ad326717cb681da13/1ffnsg0b1';
  s1.charset='UTF-8';
